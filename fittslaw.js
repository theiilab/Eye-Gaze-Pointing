...
var testDimension = makeDimension(1780, 920, 30, 30, 30, 30);
...
// FITTS LAW EXPERIMENT WITH 3 FIXED DISTANCES AND 2 WIDTHS

// The time of the last click
var lastVal = 0;
// This array holds the time taken for each click in all 6 experiments
var timeTaken = new Array();
// A counter to increment the above array.
var experimentCount = 0;
// This array holds the time taken for each click in all the current experiment
var currentTimes = new Array();
var currentRadius = 0;
var currentDistance = 0;
// Distance-width pairs
// var distanceWidthPairs = [[300, 50], [167, 50], [200, 20], [300, 20], [167, 20]];
var distanceWidthPairs = [[520, 140], [260, 140]];
...
var fittsTest = {
	...
	isoParams: {num: 9, distance: 520, width: 220, randomize: true},
	...
	generateTarget: function() {
        ...
        // Logging the current distance
        console.log("Distance: " + this.target.distance);
	...
	updateISOCircles: function() {
		...
		var insert = function(d) {
			d.attr('cx', function(d) { return d.x; })
			.attr('cy', function(d) { return d.y; })
			.attr('r', function(d) { currentRadius = (d.w/2); return d.w / 2; });
		}
	...
	mouseClicked: function(x, y) {
        ...
        // Getting the cuurent time and subtracting the previous time and pushing that in an array.
        var currentTime = new Date().getTime();
        if(lastVal == 0){
            currentTimes.push(0);
        }else{
            currentTimes.push(currentTime-lastVal);
        }
        //Updating lastVal to currentTime for next click.
        lastVal = currentTime;
	...
	randomizeParams: function() {
		// CHANGING THE RANDOM FUNCTION TO TAKE STATIC VALUES FROM AN ARRAY
        ...
        // Get the distance and width for current experiment from array. 
        this.isoParams.distance = distanceWidthPairs[experimentCount][0];
        this.isoParams.width = distanceWidthPairs[experimentCount][1];
        experimentCount++;
